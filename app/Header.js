...
const Header = () => {
    return (
        <div  className="flex flex-col w-full justify-center bg-white relative">
            <nav style={{margin: "20px", fontWeight: "600"}} className="undefined absolute z-10 top-3 bg-transparent w-full text-sm md:text-base">
                <div className="flex flex-wrap flex-row gap-1 md:justify-between justify-around max-w-6xl xl:mx-auto md:px-2 xl:px-0 w-full text-dkGreen font-semibold">
            ...
            <div style={{ height: "700px", width: "100%" }} className="relative mx-auto w-full overflow-hidden flex items-center justify-center">
                <Image
                    src={bgImg}
                ...
                <div style={{ position: "relative", top: "45%"}} className="bg-mdGreen w-full h-12"></div>
            </div>


            <h1 className="bg-white text-center text-xl md:text-3xl text-mdGreen py-2">
