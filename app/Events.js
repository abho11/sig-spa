...
const EventCard = ({ location, date, time, description, buttonText }) => (
    <div style={{width: "100%", height: "auto", marginBottom: "10px"}} className="flex flex-row items-center justify-between border border-dkGreen rounded-lg p-4 bg-ltGrey">
        <div style={{marginLeft: "50px", width:"120px"}} className="locationCon text-ltGreen flex-1 flex-col justify-start">
            <h3 className="text-ltGreen text-2xl font-bold">{location}</h3>
        </div>
            <div style={{width: "600px"}} className="dateCon flex-1 flex flex-col justify-center items-start">
        ...
        <div className="LinkCon flex-1 flex justify-end">
...
const StepsSection  = () => (
    <div style={{marginTop: "40px"}} className="stepsCon my-8 p-4 text-center text-mdGreen">
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="flex items-start mb-4">
                ...
                <div style={{marginTop: "20px", marginLeft: "50px"}} className="stepBox flex-1">
                    ...
                    <div style={{margin: "27px"}} className="stepBox flex-1  items-center mb-2">
                        <a style={{position: "relative", left: "-17%"}} href="#" className="stepList bg-tan text-mdGreen font-medium py-2 px-4 rounded-full inline-block mr-4">UtahID.org</a>
                        <span className="stepList" style={{position: "relative", left: "-47px", fontWeight: "500"}}>Obtain access to your Utah Digital ID</span>
                    </div>
                    <div  className="stepItem flex-1 justify-center items-center mb-2">
                        <a style={{position: "relative", left: "1%"}} href="#" className="stepList bg-tan text-mdGreen font-medium py-2 px-4 rounded-full inline-block mr-4">EVS.Utah.gov</a>
                        <span className="stepList" style={{position: "relative", left: "8%", fontWeight: "500"}}>Fill out all the fields until you get to "Awaiting Certification" status</span>
                    </div>
                    <Image style={{ position: "relative", marginTop: "20px", left: "27%", marginBottom: "40px"}} src={awaitImg} alt="Awaiting Certification" />
                </div>
            </div>
            {/* Step 2 */}
            <div className="stepBox2 flex items-start mb-4">
                <div style={{position: "relative", left:"-28%"}} className="text-4xl text-green-600 mr-2">
                    <Image className="img2" src={img2} alt="2" width={68} height={68} /></div>

                <div style={{ position: "relative", left: "-19%", top: "19px"}} className="stepBox flex">
                    <h3 style={{fontSize: "1.1rem"}} className="text-xl font-semibold mb-2 text-mdGreen">Check in with your QMP</h3>
                    <ul style={{fontWeight: "500", listStyle: "auto", textAlign: "left", position: "relative", left:"15%"}} className="stepList list-disc list-inside text-mdGreen">
            ...
            <div style={{marginTop: "60px"}} className=" flex items-start mb-4">
                <div style={{position: "relative", left:"-22%"}}  className="stepImg3 text-4xl text-green-600 mr-2">
                    <Image className="img3" src={img3} alt="3." width={68} height={68} /></div>

                <div className="stepBox3 flex-1">
            ...
            <Image className="leafAd" style={{width: "70%", height: "100%", marginBottom:"60px", marginTop: "60px"}} src={mockBanner} alt="Leaf Nation Advertise Banner" width={1181} height={268} />
    </div>
...
const EventsSection = () => {
    return (
        ...
        <div className="flex flex-col gap-8 items-center max-w-6xl mx-auto px-2 xl:px-0 w-full" id="Appointments">
            <h2 className="titleTag text-5xl sm:text-5xl text-dkGreen text-center font-bold">
